...
//
// class PDFConvert {
// 	static public function createPDFTech ($company, $codelanguage, $name, $questions, $result, $total_attempted, $total_un_attempted, $basic_rightanwser, $optional_rightanwser) {
// 			$questions_list_html = '';
// 			$i = 1;
...
// 			$fileName = 'tech_' . $current_date . '-' . $company . '-' . $codelanguage . '-' . $name . '.pdf';
// 			file_put_contents('testresults/' . $fileName, $output);
// 			return $fileName;
// 	}
// }
