...
QuodisysApp.controller('InformationController', ['$rootScope', '$scope', '$routeParams', '$location', '$timeout', 'Authentication', function ($rootScope, $scope, $route, $location, $timeout, Authentication) {
    ...
    }]).controller('BasicController', ['$rootScope', '$scope', '$interval', '$location', 'Authentication', '$filter', '$sce', function ($rootScope, $scope, $interval, $location, Authentication, $filter, $sce) {
        ...
        var Question = function (i, number) {
            ...
            _.questionask = $sce.trustAsHtml(number.q);
        ...
        var initQuestions = function () {
			...
			$scope.totalQuestions = (j-1);
			//console.log("T Q = "+ $scope.totalQuestions);
            $scope.timer = {
