<?php
session_start();
//require '../quodisystest/rwToken.php';
...
<head>
    ...
    <!-- Bootstrap -->
    <link href="../quodisystest/asset/css/bootstrap.min.css" rel="stylesheet">
    <link href="../quodisystest/asset/css/IQstyle.css" rel="stylesheet">
    <link href="../quodisystest/asset/css/Attitudestyle.css" rel="stylesheet">
...
<body>
    ...
    <script src="../quodisystest/asset/js/html2canvas.js"></script>
    <script src="asset/js/app.js"></script>
    <script src="asset/js/factory.js"></script>
    <script src="asset/js/controllers.js?r=<?=rand();?>"></script>
    <script>
